# Getting Started with CSharpCopier

Welcome to **CSharpCopier**, the official C# client library for MetaRPC's ultra-low latency Trade Copier engine.

## Installation

Install CSharpCopier using your language's package manager:
